...
/* WET1 enums for new policy and privilege*/

typedef enum policySw {
	DISABLE_PCL = 0,
	ENABLE_PCL = 1
} PolicySW;

typedef enum privilegeL {
	LOW_PRVL = 0,
	MID_PRVL = 1,
	HIGH_PRVL =2
} PrivilegeLvl;
...
/* WET1 struct for log list */
 typedef struct forbidden_activity_info_list{
 	int syscall_req_level;
 	int proc_level;
 	int time;
 	list_t my_ptr;
 }forbidden_activity_info_list;
...
/* WET1 policy flag {DISABLE, ENABLE}*/
	PolicySW pclSw;

/* WET1 privilege level {HIGH, MID, LOW}  */
	PrivilegeLvl prvl_lvl;

/* WET1 frobidden activity log list HEAD */
	list_t *log_head;

/*WET1 frobidden activity log list size*/
	int log_size;
};
